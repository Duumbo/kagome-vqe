...
fig, ax = plt.subplots()
# Région élémentaire
ax.plot(x, y, "o", markersize=8, color="tab:orange")
# Région pour le visuel
ax.plot(x + 4, y, "o", markersize=8, color="tab:blue")
ax.plot(x - 4, y, "o", markersize=8, color="tab:blue")
ax.plot(x, y + 2*np.sqrt(3), "o", markersize=8, color="tab:blue")
ax.plot(x, y - 2*np.sqrt(3), "o", markersize=8, color="tab:blue")
ax.plot(x + 4, y - 2*np.sqrt(3), "o", markersize=8, color="tab:blue")
ax.plot(x - 4, y - 2*np.sqrt(3), "o", markersize=8, color="tab:blue")
ax.plot(x + 4, y + 2*np.sqrt(3), "o", markersize=8, color="tab:blue")
ax.plot(x - 4, y + 2*np.sqrt(3), "o", markersize=8, color="tab:blue")
